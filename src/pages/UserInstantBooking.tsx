            ...
            {!isWithinBookingTime() ? (
                <div className="flex flex-1 items-center justify-center px-4">
                    <Card className="w-full max-w-md">
                        <CardHeader>
                            <CardTitle className='text-primary'>Instant Booking</CardTitle>
                            <CardDescription>
                                Available only between <b>10:00 AM to 8:00 PM</b>.
                            </CardDescription>
                        </CardHeader>
                    </Card>
                </div>
                ...
                <>
                    {instantBookingVar?.instantBookingJobData?.result === null && (
                        <div className="grid lg:grid-cols-2 gap-8 px-4 mt-2">
                            {/* Left Column */}
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value) => {
                                            const selectedCategory = categoryVar?.categoryData?.find(
                                                (cat) => cat._id === value
                                            );
